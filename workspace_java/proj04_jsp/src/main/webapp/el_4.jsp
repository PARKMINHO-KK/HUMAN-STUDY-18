...
<body>
	\${ 10 } : [${ 10 }]
	<br> \${ null } : [${ null }]
	<br> : null이면 아무것도 안나옴, 예외 발생하지 않음
	<br> \${ 10+5 } : ${ 10+5 } : 간단한 연산이 가능하다
	<br> \${ "10"+5 } : ${ "10"+5 } : EL은 계산할 때 문자를 숫자로 바꾼다
	<br>
	<%-- 	\${ "a"+5 } : ${ "a"+5 } --%>
	<%-- 	\${ "a"+b } : ${ "a"+b } --%>
	\${ "a" } : ${ "a" }
	<br> \${ "a" += 1 } : ${ "a" += 1 }
	<br> \${ 10 % 4 } : ${ 10 % 4 }
	<br> \${ 10 mod 4 } : ${ 10 mod 4 }
	<br> \${ 10 / 4 } : ${ 10 / 4 }
	<br> \${ 10 div 4 } : ${ 10 div 4 }
	<br> \${ 10 == 4 } : ${ 10 == 4 }
	<br> \${ 10 eq 4 } : ${ 10 eq 4 }
	<br> \${ "a" eq "a" } : ${ "a" eq "a" }
	<br> \${ 10 != 4 } : ${ 10 != 4 }
	<br> \${ 10 ne 4 } : ${ 10 ne 4 } : not equal
	<br> ${!( "a" eq "a") } : ${ !("a" eq "a") }
	<br>
	<hr>
	${ 10 > 4 } : ${ 10 > 4 }
	<br> ${ 10 gt 4 } : ${ 10 gt 4 } : greater then
	<br>
	<hr>
	${ 10 < 4 } : ${ 10 < 4 }
	<br> ${ 10 lt 4 } : ${ 10 lt 4 } : less then 또는 little then
	<br>
	<hr>
	${ 10 >= 4 } : ${ 10 >= 4 }
	<br> ${ 10 ge 4 } : ${ 10 ge 4 } : greater or equal
	<br>
	<hr>
	${ 10 <= 4 } : ${ 10 <= 4 }
	<br> ${ 10 le 4 } : ${ 10 le 4 } : less or equal
	<br>
	<hr>
	${ (10 <= 4) eq "false" } : ${ (10 <= 4) eq "false" } : 결과는 글씨다
	<br>
